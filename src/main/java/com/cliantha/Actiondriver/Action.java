 ...
 * 
 */
package com.cliantha.Actiondriver;
...
import com.cliantha.Actioninterface.ActionInterfaces;
 ...
 *
 */
public class Action extends BaseCliantha implements ActionInterfaces {
	@Override
	...
	public String screenShot(WebDriver driver, String filename) {
		...
		String newImageString = "user.dir" + "\\ScreenShots" + filename + "_" + dateName + ".png";
		return destination;
	}
	@Override
